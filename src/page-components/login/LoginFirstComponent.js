...
const LoginFirstComponent = ({email,emailError,passwordError,password,setPassword,setEmail,login,setEmailError,setPasswordError}) => {
    ...
    return <Box display={'flex'} flexDirection={'column'} mt={{md:0,sm:0,xs:0}}>
        ...
        <Box mt={1} alignItems="center" display={'flex'}>
            ...
            >
                ...
                <span style={{color:'blue',cursor:'pointer'}} onClick={async () =>{
